...
export default function VideosScreen() {
  ...
  async function ensureMediaPermission(): Promise<boolean> {
    ...
    if (!req) {
      Alert.alert(
        'Permission Required',
        'Please allow photo library access to save videos. You can enable it in Settings.',
        [{ text: 'OK' }]
      );
    }
    return req;
          ...
          <View style={{ flex: 1 }}>
            {loading ? (
              ...
              <StatusGrid
                ...
                emptyText="No video statuses found. View some statuses in WhatsApp, then pull to refresh. If you already picked a folder, you may have picked the wrong level — try picking the .Statuses folder again."
                emptyAction={
                  <View style={{ gap: 8 }}>
                    <Pressable
